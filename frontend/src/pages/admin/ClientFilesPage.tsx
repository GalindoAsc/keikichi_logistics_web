        ...
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden transition-colors">
                <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Expediente de Cliente</h1>
                        {user && (
                    ...
                    {filteredDocs.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {filteredDocs.map((doc) => (
                                <div key={doc.id} className="border border-slate-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md dark:hover:shadow-slate-800/30 transition-shadow relative group bg-white dark:bg-slate-900">
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <span className={`text-[10px] px-2 py-0.5 rounded-full ${doc.is_approved ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400'}`}>
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="flex-1 flex items-center justify-center gap-2 text-sm bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 py-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
                                        >
