            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="p-6 border-b border-slate-200 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-slate-900">Historial de Notificaciones</h1>
                            <p className="text-slate-500 text-sm">Registro completo de actividad</p>
                        </div>
                    </div>
                ...
                <div className="divide-y divide-slate-100">
                    {notifications.length === 0 ? (
                        <div className="p-12 text-center">
                            ...
                            <p className="text-slate-500 mt-1">Tu historial de actividad aparecerá aquí</p>
                        </div>
                    ) : (
                        notifications.map((notification) => (
                            <div
                                ...
                                className={`p-6 hover:bg-slate-50 transition-colors cursor-pointer group ${!notification.is_read ? 'bg-indigo-50/30' : ''}`}
                            >
