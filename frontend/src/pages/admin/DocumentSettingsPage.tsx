                ...
                <div className="p-6">
                    {activeTab === "company" && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-4 bg-keikichi-lime-50 dark:bg-keikichi-forest-700/50 text-keikichi-forest-700 dark:text-keikichi-lime-300 rounded-lg border border-keikichi-lime-200 dark:border-keikichi-forest-600 transition-colors">
                                ...
                                <button
                                    ...
                                    className="text-sm bg-white dark:bg-keikichi-forest-600 border border-keikichi-lime-200 dark:border-keikichi-forest-500 px-3 py-1.5 rounded-md hover:bg-keikichi-lime-50 dark:hover:bg-keikichi-forest-500 transition-colors flex items-center gap-2 shadow-sm text-keikichi-forest-700 dark:text-keikichi-lime-100"
                                >
                    ...
                    {activeTab === "documents" && (
                        <div className="space-y-6">
                            <div>
                                ...
                                />
                                <p className="text-xs text-keikichi-forest-500 dark:text-keikichi-lime-400/70 mt-1">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={8}
                                    className="w-full border border-keikichi-lime-200 dark:border-keikichi-forest-600 rounded-lg px-3 py-2 bg-white dark:bg-keikichi-forest-700 text-keikichi-forest-800 dark:text-white focus:ring-2 focus:ring-keikichi-lime-500 focus:border-keikichi-lime-500 font-mono text-sm"
                    ...
                    {activeTab === "instructions" && (
                        <div className="space-y-6">
                            ...
                            <div className="bg-keikichi-lime-50 dark:bg-keikichi-forest-700/30 border border-keikichi-lime-200 dark:border-keikichi-forest-600 rounded-xl p-5 transition-colors">
                                <h3 className="font-semibold text-keikichi-forest-800 dark:text-keikichi-lime-400 mb-4 flex items-center gap-2">
                                    💵 Pago en Efectivo (Bodega)
                                </h3>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows={3}
                                            className="w-full border border-keikichi-lime-300 dark:border-keikichi-forest-500 rounded-lg px-3 py-2 bg-white dark:bg-keikichi-forest-800 text-keikichi-forest-900 dark:text-white focus:ring-2 focus:ring-keikichi-lime-500 focus:border-keikichi-lime-500 text-sm"
                                            placeholder="El pago se realizará al entregar tu carga en bodega..."
                                        />
                                        <p className="text-xs text-keikichi-forest-500 dark:text-keikichi-lime-400/70 mt-1">
                                            Aparece en el recuadro izquierdo del PDF.
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows={4}
                                            className="w-full border border-keikichi-lime-300 dark:border-keikichi-forest-500 rounded-lg px-3 py-2 bg-white dark:bg-keikichi-forest-800 text-keikichi-forest-900 dark:text-white focus:ring-2 focus:ring-keikichi-lime-500 focus:border-keikichi-lime-500 font-mono text-sm"
                            ...
                            <div className="bg-keikichi-lime-50 dark:bg-keikichi-forest-700/30 border border-keikichi-lime-200 dark:border-keikichi-forest-600 rounded-xl p-5 transition-colors">
                                ...
                                <div>
                                    ...
                                    />
                                    <p className="text-xs text-keikichi-forest-500 dark:text-keikichi-lime-400/70 mt-1">
                                        Los datos bancarios se configuran en "Datos Bancarios".
                                    </p>
                                </div>
                            </div>
                            ...
                            <details className="bg-white dark:bg-keikichi-forest-700 border border-keikichi-lime-200 dark:border-keikichi-forest-600 rounded-xl transition-colors">
                                <summary className="px-5 py-3 cursor-pointer text-sm font-medium text-keikichi-forest-600 dark:text-keikichi-lime-400 hover:text-keikichi-forest-800 dark:hover:text-keikichi-lime-200">
